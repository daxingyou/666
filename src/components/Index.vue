<template>
	...
	<div class="mobile-wrap center bj2">
			...
			<ul class="swiper-wrapper swiper-set">
				<li v-for="item in carouselList" class="swiper-slide">
					<template v-if="item.url">
						<a :href="appEmbedApiAddress+item.url" title="">
			...
			<ul>
				...
				<li>
					<router-link to="/BuyNsidePage/6">
						...
						<div class="text">
							<b>六合彩</b>
							<p><span>{{ downTime(OpenCode.leftTime) }}</span></p>
						</div>
					</router-link>
				</li>
				<li>
		...
		<div class="down-app center hide">
			...
			<p>下载APP，随时随地，极速体验！</p>
			<a href="#" title="" target="_blank">下载APP</a>
		</div>
	...
	export default {
		...
		methods:{
			...
			getAppConfig(){
				...
				data => {
					_this.appEmbedApiAddress=data.appEmbedApiAddress
				})
			},
			// 公告
			notice(){

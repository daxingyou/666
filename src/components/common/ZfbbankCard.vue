			...
			<div class="cg list">
				<ul>
					<li>
						...
						<button class="more-btn">更多账号</button>
					</li>
					<li>
						<span>转账卡号：</span>
				...
				<div class="pub-wrap">
					<a href="alipay://" title="" target="_blank">打开支付宝</a>
				</div>
			</div>
			<div class="cg order">
				<ul>
					...
					<li>
						<span>支付宝昵称:</span>
						<input type="text" v-model="zfbname" placeholder="填写转账的支付宝真实姓名">
					</li>
				</ul>
				<div class="pub-wrap">
	...
	export default{
		...
		mounted(){
			...
			this.$nextTick(function(){
				...
				$(".wx-wrap .list ul li button.more-btn").click(function(){

<template>
	...
	<div class="mobile-wrap center">
		...
		<div class="pub-wrap">
			<router-link to="/ConfirmationOfTransfer" replace>提交</router-link>
		</div>
		...
		<div class="alert-box-course center">
			<div class="layout">
				...
				<div class="box">
					<p><i>1.</i>打开支付宝，左上角，点击扫一扫进行转账；</p>
					<div class="pict">
						<img style="width: 6.82rem;" src="../../../static/img/jiaocheng/zfb1.png" alt="">
					</div>
					<p><i>2.</i>添加收款人微信号（如：田伟伟），进行微信转账</p>
					<div class="pict">
						<img style="width: 7.06rem;" src="../../../static/img/jiaocheng/zfb2.png" alt="">
					</div>
					<p><i>3.</i>点击支付宝下导航，进入朋友页面，点击右上角+，点击添加朋友，输入账号，添加完成后，点击下方+，进行转账；</p>
					<div class="pict">
						<img style="width: 7.06rem;" src="../../../static/img/jiaocheng/zfb3.png" alt="">
					</div>
				</div>
			</div>
		</div>

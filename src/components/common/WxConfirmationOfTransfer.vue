<template>
	<div class="mobile-wrap center bj2">
		...
		<div class="recharge-amount-transfer">
			...
			<div class="info">
				<span>转账信息</span>
				<input type="text" v-model="info" placeholder="微信名字或转账单号的后四位">
			</div>
			<div class="pub-wrap">
				<button :class="{'no':info.length==0}" @click="submitWeixinzz">确认提交，极速入款</button>
			</div>
			<div class="query">
				<b>"如何查询订单号？"</b>
				<p>1、打开微信，点击右下角"我"。</p>
				<p>2、进入"钱包",点击右上角<i class="ico-menu"></i></p>
				<p>3、点击"交易记录"</p>
				<p>4、点击对应的转账信息即可查询转账单号</p>
			</div>

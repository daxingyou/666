<template>
	...
	<div id="iframe">
		...
		<div class="hcl-container">
			...
			<div class="number">
				<div class="item signal"><span>01</span></div>
				<div class="item signal"><span>02</span></div>
				<div class="item signal"><span>03</span></div>
				<div class="item signal"><span>04</span></div>
				<div class="item signal"><span>05</span></div>
				<div class="item signal"><span>06</span></div>
				<div class="item signal"><span>07</span></div>
				<div class="item signal"><span>08</span></div>
				<div class="item signal"><span>09</span></div>
				<div class="item signal"><span>10</span></div>
				<div class="item signal"><span>11</span></div>
			</div>
		</div>
		<div class="hcl-container">
	...
	export default{
		...
		mounted(){
			...
			$('.machine-select h3 p span').on('click',function() {
				...
				var resuit = rand_one_zhu(total,2);
            ...
            function zhu_check(){
                return $('.hcl-container .number .item.active').length>=2&&$('.hcl-container .number').eq(0).children('.item.active').length>0?true:false
            }
            function total_zhu() {
			...
			$('.hcl-container .number .item').on('click',function() {
                ...
                if($(this).hasClass('signal active')){

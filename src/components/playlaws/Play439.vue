...
<script>
	export default{
		...
		methods:{
			...
			playPl(val){
				return this.getFilterPlay.filter(obj=>{
					if(obj.name==val){
						return obj
					}
				})
											...
											if(k!=j){
												if(l!=k){
													if(m!=l){
														...
														if(arr[j]=="狗"){
															_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m],arr[j])
														}else if(arr[k]=="狗"){
															_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m],arr[k])
														}else if(arr[l]=="狗"){
															_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m],arr[l])
														}else if(arr[m]=="狗"){
															_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m],arr[m])
														}else{
															_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m],arr[i])
														}

								...
								for(var l=k;l<arr.length;l++){
									if(j!=i){
										if(k!=j){
											if(l!=k){
												if(arr[j]=="狗"){
													_this.CallData(arr[i]+','+arr[j]+','+arr[k]+','+arr[l],arr[j])
												}else if(arr[k]=="狗"){
													_this.CallData(arr[i]+','+arr[j]+','+arr[k]+','+arr[l],arr[k])
												}else if(arr[l]=="狗"){
													_this.CallData(arr[i]+','+arr[j]+','+arr[k]+','+arr[l],arr[l])
												}else{
													_this.CallData(arr[i]+','+arr[j]+','+arr[k]+','+arr[l],arr[i])
												}
											}
										}
									}

		...
		mounted(){
			...
			_this.$nextTick(function(){
				...
				function count(obj){
					...
					// 注数
					_this.setValue.notes=$(".color-ball .right ul").eq(0).find('li.color').length*$(".color-ball .right ul").eq(1).find('li.color').length*$(".color-ball .right ul").eq(1).find('li.color').length
				...
				$(".machine-select h3 p .one").click(function(){
					...
					$(".color-ball").eq(2).find('li').eq(arr3[0]-1).addClass('color').siblings().removeClass('color')

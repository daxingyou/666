			...
			<div class="always">
				<ul>
					<li>
						...
						<div class="number">
							<span class="m d">1</span>
							<span class="m s">2</span>
							<span class="m d">3</span>
							<span class="m s">4</span>
							<span class="m d">5</span>
							<span class="l s">6</span>
							<span class="l d">7</span>
							<span class="l s">8</span>
							<span class="l d">9</span>
		...
		mounted(){
			...
			_this.$nextTick(()=>{
				...
				$(".machine-select h3 p .one").click(function(){
					...
					$(".machine-select ul li").eq(random(10)-1).find('.number span').eq(random(10-1)).addClass('color');
					// 调用统计
					count();
				})

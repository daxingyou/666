	...
	<div id="iframe">
		...
		<div class="machine-select">
			...
			<div class="color-ball">
				...
				<div class="right">
					<ul>
						<li><strong>1</strong><p>6.5</p></li>
						<li><strong>2</strong><p>6.5</p></li>
						<li><strong>3</strong><p>6.5</p></li>
						<li><strong>4</strong><p>6.5</p></li>
						<li><strong>5</strong><p>6.5</p></li>
						<li><strong>6</strong><p>6.5</p></li>
			...
			_this.$nextTick(function(){
				...
				function count(obj){
					...
					$($oLi).find('li').each(function(index){
						...
						// str.substring(1);
						zhushu.playPlId=parseFloat(11758)
						zhushu.playPl=parseFloat(6.5)

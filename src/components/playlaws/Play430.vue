	...
	<div id="iframe">
		...
		<div class="main">
			...
			<div class="right three">
				<ul>
					<li><b>鼠</b><var>1.95</var></li>
					<li><b>牛</b><var>1.95</var></li>
					<li><b>虎</b><var>1.95</var></li>
					<li><b>兔</b><var>1.95</var></li>
					<li><b>龙</b><var>1.95</var></li>
					<li><b>蛇</b><var>1.95</var></li>
					<li><b>马</b><var>1.95</var></li>
					<li><b>羊</b><var>1.95</var></li>
					<li><b>猴</b><var>1.95</var></li>
					<li><b>鸡</b><var>1.95</var></li>
					<li><b>狗</b><var>1.95</var></li>
					<li><b>猪</b><var>1.95</var></li>
				</ul>
			</div>
		</div>
											...
											if(j!=i){
												if(k!=j){
													if(l!=k){
														if(m!=l){
															if(n!=m){
																_this.addZhu(arr[i]+','+arr[j]+','+arr[k]+','+arr[l]+','+arr[m]+','+arr[n])
															}
														}
													}
												}

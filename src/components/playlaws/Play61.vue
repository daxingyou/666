			...
			<div class="color-ball">
				...
				<div class="right">
					<ul>
                        ...
                        <li data-zhu="1"><strong>2</strong></li>
                        <li data-zhu="2"><strong>3</strong></li>
                        <li data-zhu="2"><strong>4</strong></li>
                        <li data-zhu="3"><strong>5</strong></li>
                        <li data-zhu="3"><strong>6</strong></li>
                        <li data-zhu="4"><strong>7</strong></li>
                        <li data-zhu="4"><strong>8</strong></li>
                        <li data-zhu="5"><strong>9</strong></li>
                        <li data-zhu="4"><strong>10</strong></li>
                        <li data-zhu="4"><strong>11</strong></li>
                        <li data-zhu="3"><strong>12</strong></li>
                        <li data-zhu="3"><strong>13</strong></li>
                        <li data-zhu="2"><strong>14</strong></li>
                        <li data-zhu="2"><strong>15</strong></li>
                        <li data-zhu="1"><strong>16</strong></li>
                        <li data-zhu="1"><strong>17</strong></li>
					</ul>
				</div>
			</div>

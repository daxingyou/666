	...
	<div id="iframe">
		...
		<div class="machine-select">
			...
			<div class="color-ball">
				...
				<div class="right">
					<ul>
						<!-- <li><strong>1</strong><p>1.6</p></li>
						<li><strong>2</strong><p>1.6</p></li>
						<li><strong>3</strong><p>1.6</p></li>
						<li><strong>4</strong><p>1.6</p></li>
						<li><strong>5</strong><p>1.6</p></li>
						<li><strong>6</strong><p>1.6</p></li> -->

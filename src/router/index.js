...
// 注单明细
const Noteanddetail = resolve => require(['@/components/Noteanddetail'],resolve)
...
// 提现记录
const PresentRecord = resolve => require(['@/components/Record/PresentRecord'],resolve)

// 投注记录
const NoteRecord = resolve => require(['@/components/Record/NoteRecord'],resolve)
...
// 充值记录
const RechargeRecord = resolve => require(['@/components/Record/RechargeRecord'],resolve)
...
// 资金记录
const Capitalrecord = resolve => require(['@/components/Record/Capitalrecord'],resolve)

// 转账记录
const Transferrecord = resolve => require(['@/components/Record/Transferrecord'],resolve)
...
const routes= [
	...
	{
		path: '/Noteanddetail/:id',	//注单明细
		name: 'Noteanddetail',
		component:Noteanddetail,
		meta:{
			index:7
		}
	},

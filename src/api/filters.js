...
Vue.filter('Capitalrecord',value =>{
	...
	if(value==28) str='AG转余额';
	if(value==29) str='余额转AG';
	if(value==31) str='coinOperType-31';
	...
	if(value==13) str='撤单/投注撤单';
	if(value==14) str='手动扣款';
	if(value==15) str='手动存款';
	if(value==16) str='提现/用户出款(拒绝)';
	if(value==17) str='彩票返水';
	if(value==18) str='彩票返点';

	if(value==19) str='代理佣金';

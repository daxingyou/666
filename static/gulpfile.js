...
gulp.task('watch', function() {
    ...
    // vue-cli
    gulp.watch("../src/compoents/*.vue").on('change', reload);
    gulp.watch("../src/compoents/*.html").on('change', reload);
    gulp.watch("../src/*.js").on('change', reload);
    gulp.watch("../src/*.vue").on('change', reload);
    gulp.watch("../src/router/*.js").on('change', reload);
    gulp.watch("../src/api/*.js").on('change', reload);
})
